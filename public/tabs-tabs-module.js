...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'shedule',
                loadChildren: () => __webpack_require__.e(/*! import() | modules-shedule-shedule-module */ "modules-shedule-shedule-module").then(__webpack_require__.bind(null, /*! ../modules/shedule/shedule.module */ "9ziR")).then((m) => m.ShedulePageModule),
                canLoad: [_modules_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
                canActivate: [_modules_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
            },
            {
