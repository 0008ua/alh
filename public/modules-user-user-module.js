...
const routes = [
    ...
    {
        path: 'profile',
        loadChildren: () => __webpack_require__.e(/*! import() | profile-profile-module */ "profile-profile-module").then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "GMam")).then((m) => m.ProfilePageModule),
        canLoad: [_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        canActivate: [_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
    },
    {
