...
/*!**************************************************!*\
  ...
  \**************************************************/
/*! exports provided: SheduleActionTypes, GetBookings, GetBookingsSuccess */
...
let EntityToastService = class EntityToastService {
    constructor(actions$, toastController) {
        ...
        actions$
            .pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["UserActionTypes"].UpdateUserSuccess, _actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["UserActionTypes"].UpdateUserFail))
            .subscribe((action) => this.presentToast(`Update user ${action.type}`));
    }
            ...
            if (err.status === 401 && !this.refreshInProgress) {
                ...
                return this.userService.deviceInfo().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((deviceInfo) => {
                    ...
                    if (refreshResult.status === 200) {
                        ...
                        this.store.dispatch(new src_app_store_actions_user_actions__WEBPACK_IMPORTED_MODULE_8__["Login"]({ token }));
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, userService, router, store) {
    ...
    onLogout() {
        this.store.dispatch(new _store_actions_user_actions__WEBPACK_IMPORTED_MODULE_10__["Logout"]());
...
let UserService = class UserService {
    ...
    login(user) {
        ...
        return this.deviceInfo().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])((deviceInfo) => this.http.post(this.host + 'api/user/login', Object.assign(Object.assign({}, user), { deviceInfo }), httpOptions)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])((token) => this.store.dispatch(new _store_actions_user_actions__WEBPACK_IMPORTED_MODULE_11__["Login"]({ token, redirectionUrl: '/' }))));
    }
    createCompany(companySignup) {
        ...
        return this.http.post(this.host + 'api/user/create-company', companySignup, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])((token) => this.store.dispatch(new _store_actions_user_actions__WEBPACK_IMPORTED_MODULE_11__["Login"]({ token, redirectionUrl: '/' }))));
    }
...
/*!***********************************************!*\
  ...
  \***********************************************/
/*! exports provided: UserActionTypes, GetUser, GetCompanyByUser, CompanyAuthenticated, Authenticated, NotAuthenticated, Redirection, AuthError, Login, Logout, LogoutOnFront, ActivateUser, UpdateUser, UpdateUserSuccess, UpdateUserFail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function reducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case _actions_user_actions__WEBPACK_IMPORTED_MODULE_1__["UserActionTypes"].authError:
            return Object.assign(Object.assign({}, state), { user: initialState.user, company: initialState.company, redirectionUrl: '/user/login', loading: false });
        case _actions_user_actions__WEBPACK_IMPORTED_MODULE_1__["UserActionTypes"].UpdateUserSuccess:
            return Object.assign({}, state);
        case _actions_user_actions__WEBPACK_IMPORTED_MODULE_1__["UserActionTypes"].UpdateUserFail:
            return Object.assign({}, state);
...
let SheduleService = class SheduleService {
    constructor(http, store) {
        ...
        this._rooms$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["ReplaySubject"](1);
    ...
    convertShortToDate(short) {
        return date_fns__WEBPACK_IMPORTED_MODULE_7__["parseISO"](short);
    }
    // '2020-12-01T00:00:00.000Z' => Tue Dec 01 2020 00:00:00 GMT-1000
    convertISOToDate(ISO) {
        return date_fns__WEBPACK_IMPORTED_MODULE_7__["parseISO"](ISO.substring(0, 10));
    }
    ...
    convertDateToShort(date) {
        return date_fns__WEBPACK_IMPORTED_MODULE_7__["formatISO"](date, { representation: 'date' });
    }
    /* End of date helpers */
    /* new */
    getRoomById(id) {
...
/*!***************************************************!*\
  ...
  \***************************************************/
/*! exports provided: sheduleFeatureKey, initialState, reducer, getBookings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
