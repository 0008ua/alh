...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-menu side=\"end\" contentId=\"analytics-content\">\n  <ion-header>\n    <ion-toolbar color=\"secondary\">\n      <ion-title>\n        <h2>Analytics</h2>\n      </ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content>\n    <ion-list lines=\"none\">\n      <ion-menu-toggle contentId=\"analytics-content\">\n        <ion-item button routerLink=\"/analytics/summary\" routerLinkActive=\"active-link\"\n          [routerLinkActiveOptions]=\"{exact: true}\">\n          <ion-icon name=\"person-circle-outline\" slot=\"start\"></ion-icon>\n          <ion-label>Summary</ion-label>\n        </ion-item>\n      </ion-menu-toggle>\n\n      <ion-menu-toggle contentId=\"analytics-content\">\n        <ion-item button routerLink=\"/analytics/management\" routerLinkActive=\"active-link\"\n          [routerLinkActiveOptions]=\"{exact: true}\">\n          <ion-icon name=\"business-outline\" slot=\"start\"></ion-icon>\n          <ion-label>Management</ion-label>\n        </ion-item>\n      </ion-menu-toggle>\n\n    </ion-list>\n  </ion-content>\n</ion-menu>\n<ion-router-outlet id=\"analytics-content\"></ion-router-outlet>");
...
/* harmony import */ var _analytics_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./analytics.page */ "YGjb");
...
const routes = [
    {
        path: '',
        component: _analytics_page__WEBPACK_IMPORTED_MODULE_4__["AnalyticsPage"],
        children: [
            {
                path: '',
                redirectTo: 'summary',
            ...
            {
                path: 'management',
                loadChildren: () => __webpack_require__.e(/*! import() | management-management-module */ "management-management-module").then(__webpack_require__.bind(null, /*! ./management/management.module */ "nhAk")).then((m) => m.ManagementPageModule),
            ...
            {
                path: 'summary',
                loadChildren: () => __webpack_require__.e(/*! import() | summary-summary-module */ "summary-summary-module").then(__webpack_require__.bind(null, /*! ./summary/summary.module */ "zWcS")).then((m) => m.SummaryPageModule),
                canLoad: [_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
                canActivate: [_user_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
            },
        ],
